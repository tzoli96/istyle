...
{        
    ...
    protected function _headerContent($form)
    {
        ...
        {
            $fieldset->addField('message_general_'.$key, 'label', array(
                'label' => "",                                    
                "value" => $message
            ));
        }        
    ...
    protected function _connectorContent($form)
    {
        ...
        foreach($messageArray as $key => $message)
        {
            $fieldset->addField('message_connector_'.$key, 'label', array(
                'label' => "",                                    
                "value" => $message
            ));
        }
        
        $fieldset->addField('activate_trial', 'button', array(
        ...
        $fieldset->addField('activate_live', 'button', array(
    ...
    protected function _serviceContent($form)
    {
        ...
        foreach($messageArray as $key => $message)
        {
            $fieldset->addField('message_service_'.$key, 'label', array(
                'label' => "",                                    
                "value" => $message
            ));
        }
        
        $fieldset->addField('activate_service', 'button', array(
