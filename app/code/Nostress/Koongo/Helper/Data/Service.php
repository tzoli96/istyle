...
class Service extends \Nostress\Koongo\Helper\Data
{
    ...
    )
    {
        ...
        parent::__construct($context, $productType, $logger, $currencyFactory, $resourceConfig, 
                            $storeManager, $configDataFactory, $filesystem, $coreConfig,
                            $datetimeformat, $eavConfig, $cache, $moduleList, $productMetadataInterface,
                            $appState);
    }
    ...
    {
        //Set your Data
        $integrationName = \Nostress\Koongo\Helper\Data::KOONGO_SYSTEM_INTEGRATION_NAME;
