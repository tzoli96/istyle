...
abstract class BaseObserver implements ObserverInterface
{
    ...
    {        
        ...
        /**
     * Prepare cancel order events and process events
     *
    ...
    /**
     * Prepare shipment events and process events
     *
    ...
    /**
     * Prepare new product event and process events
     *
    ...
    /**
     * Prepare update product event and process events
     *
     * @param \Magento\Catalog\Model\Product $product
     * @return void
     */
    ...
    /**
     * Prepare delete product event and process events
     *
     * @param \Magento\Catalog\Model\Product $product
     * @return void
     */
    ...
    /**
     * Prepare batch product import event and process events
     *
    ...
    /**
     * Prepare batch product delete event and process events
     *
