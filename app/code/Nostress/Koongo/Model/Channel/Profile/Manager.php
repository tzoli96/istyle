...
class Manager  extends \Nostress\Koongo\Model\AbstractModel
{
	...
	*/
    ...
    protected function reloadCache($profiles)
    {
    	...
    	{
            $this->cacheManager->reloadAllCache($cacheReloadData['store_ids'], 
    ...
    protected function getCacheReloadDataFromProfiles($profiles)
    {
    	...
    	return array("store_ids" => $storeIds, "website_ids" => $websiteIds, "price_reload_list" => $priceReloadList, "price_tier_reload_list" => $priceTierReloadList);
    }
    ...
    {                   
        ...
        else
        {
            ...
            if(isset($feedCustomParams[Profile::CONFIG_CODE]))
                $feedCustomParams = array($feedCustomParams);
        }
