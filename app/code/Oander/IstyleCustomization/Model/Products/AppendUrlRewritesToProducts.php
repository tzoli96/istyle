...
namespace Oander\IstyleCustomization\Model\Products;

use Magento\Catalog\Api\Data\ProductInterface;
use Magento\Catalog\Model\Product;
use Magento\Catalog\Model\Product\Visibility;
use Oander\IstyleCustomization\Model\Product\GetProductUrlRewriteDataByStore;
...
class AppendUrlRewritesToProducts
{
     ...
     */
    public function execute(array $products, array $storesToAdd)
    {
        foreach ($products as $product) {
            ...
            if ($product->getStoreId() === ((string)Store::DEFAULT_STORE_ID)
     ...
     * @return array
     */
    private function generateUrls(ProductInterface $product, int $storeId)
    {
     ...
     * @return bool
     */
    private function needGenerateUrlForStore(ProductInterface $product, int $storeId)
    {
     ...
     * @return bool
     */
    private function isProductAssignedToStore(ProductInterface $product)
    {
