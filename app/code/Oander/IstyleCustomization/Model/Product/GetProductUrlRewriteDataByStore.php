...
namespace Oander\IstyleCustomization\Model\Product;

use Magento\Catalog\Api\Data\ProductInterface;
use Oander\IstyleCustomization\Model\ResourceModel\Product\GetUrlRewriteData;
...
class GetProductUrlRewriteDataByStore
{
     ...
     * @return array
     */
    public function execute(ProductInterface $product, int $storeId)
    {
