...
namespace Oander\AutorelatedWarehouseManagerExtender\Plugin\Model\Rule\Viewed\Condition;
...
/**
 * Class Combine
 * @package Oander\AutorelatedWarehouseManagerExtender\Plugin\Model\Rule\Viewed\Condition
 */
class Combine
{
    /**
     * @param \Aheadworks\Autorelated\Model\Rule\Viewed\Condition\Combine $subject
     * @param                                                             $result
     *
     * @return array
     */
    public function afterGetNewChildSelectOptions(\Aheadworks\Autorelated\Model\Rule\Viewed\Condition\Combine $subject, $result)
    {
        $result[] = [
            'value' => [
                [
