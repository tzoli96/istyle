define([
  ...
  var customerAddressValidation = {
    defaults: {
      ...
      city: '[name="city"]',
      storecode: window.checkoutConfig.storeCode.split('_')[0].toUpperCase(),
      endpoint: url.build('rest/V1/checkout/address/getCityByZip'),
      error: '',
    },
  ...
  return customerAddressValidation._create();
});
