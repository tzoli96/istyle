...
class Main extends Template
{
    ...
    {
        return ''; //return $this->getUrl(\Oander\ApplePay\Controller\Ajax\PaymentRequest::ROUTE);
    }
    ...
    public function getJsonConfig()
    {
        ...
        $config['quoteDetailsURL'] = ''; // $config['quoteDetailsURL'] = $this->getUrl(\Oander\ApplePay\Controller\Ajax\PaymentRequest::ROUTE);
        $config['version'] = 4;
