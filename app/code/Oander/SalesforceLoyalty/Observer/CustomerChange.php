...
class CustomerChange implements ObserverInterface
{
    ...
    private function saveLoyaltyAttribute($customerId)
    {
        ...
        if (($customer->getCustomAttribute(CustomerAttribute::LOYALTY_STATUS) ? (int)$customer->getCustomAttribute(CustomerAttribute::LOYALTY_STATUS)->getValue() : LoyaltyStatusEnum::VALUE_NOT_REGISTERED) === LoyaltyStatusEnum::VALUE_NOT_REGISTERED) {
