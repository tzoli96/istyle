...
namespace Oander\CustomerExtend\Model\Entity\Attribute\Source;

class IsCompany extends \Magento\Eav\Model\Entity\Attribute\Source\AbstractSource
{
    ...
    public function getAllOptions()
    {
        if ($this->_options === null) {
            $this->_options = [
                ...
                ['label' => __('Company'), 'value' => self::VALUE_COMPANY],
            ];
        }
    ...
    {
        switch ($value) {
            case self::VALUE_INDIVIDUAL:
                return 'Individual';
            case self::VALUE_COMPANY:
                return 'Company';
        }
