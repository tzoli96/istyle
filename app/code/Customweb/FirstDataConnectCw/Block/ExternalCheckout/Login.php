...
class Login extends AbstractExternalCheckout
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_FirstDataConnectCw::externalcheckout/login.phtml';
	...
	{
		return $this->getUrl('firstdataconnectcw/externalCheckout/loginPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('firstdataconnectcw/externalCheckout/guestPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('firstdataconnectcw/externalCheckout/registerPost', ['_secure' => true]);
	}
