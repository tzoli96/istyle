...
namespace Customweb\FirstDataConnectCw\Block\Adminhtml\Sales\Order\Invoice\Create;
...
class Components extends \Magento\Framework\View\Element\Template
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_FirstDataConnectCw::sales/order/invoice/create/components.phtml';
