...
class Tabs extends \Magento\Backend\Block\Widget
{
     ...
     * @var string
     */
    protected $_template = 'Customweb_FirstDataConnectCw::firstdataconnectcw/config/tabs.phtml';
    ...
    public function __construct(
        ...
        $this->setId('firstdataconnectcw_config_tabs');
        $this->setTitle(__('FirstData Connect'));
