...
class View extends \Customweb\FirstDataConnectCw\Controller\Adminhtml\Transaction
{
	public function execute()
	{
		...
		if ($transaction) {
			...
			$resultPage->getConfig()->getTitle()->prepend(__('FirstData Connect Transactions'));
			$resultPage->getConfig()->getTitle()->prepend(sprintf("#%s", $transaction->getIncrementId()));
			return $resultPage;
		}
		$resultRedirect->setPath('firstdataconnectcw/transaction/');
