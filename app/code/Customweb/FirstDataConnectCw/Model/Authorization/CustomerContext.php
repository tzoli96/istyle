 ...
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\CustomerContext setContextId(string $value)
 * @method string getCustomerId()
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\CustomerContext setCustomerId(string $value)
 * @method array getValues()
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\CustomerContext setValues(array $value)
 * @method int getVersionNumber()
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\CustomerContext setVersionNumber(int $value)
 */
class CustomerContext extends \Magento\Framework\Model\AbstractModel implements \Customweb_Payment_Authorization_IPaymentCustomerContext
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_firstdataconnectcw_customer_context';
	 ...
	 * @param \Customweb\FirstDataConnectCw\Model\Authorization\CustomerContextFactory $factory
	...
	public function __construct(
			...
			\Customweb\FirstDataConnectCw\Model\Authorization\CustomerContextFactory $factory,
    ...
    {
        $this->_init('Customweb\FirstDataConnectCw\Model\ResourceModel\Authorization\CustomerContext');
     ...
     * @return \Customweb\FirstDataConnectCw\Model\Authorization\CustomerContext
     */
