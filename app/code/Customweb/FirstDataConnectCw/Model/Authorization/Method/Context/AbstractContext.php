...
abstract class AbstractContext implements IContext
{
	...
	/**
	 * @var \Customweb\FirstDataConnectCw\Model\Authorization\CustomerContext
	 */
	...
	{
		if (!($this->customerContext instanceof \Customweb\FirstDataConnectCw\Model\Authorization\CustomerContext)) {
