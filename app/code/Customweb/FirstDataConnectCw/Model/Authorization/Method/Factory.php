...
class Factory
{
     ...
     */
    public function create(\Customweb\FirstDataConnectCw\Model\Authorization\Method\Context\IContext $context)
    {
    	if ($context->isMoto()) {
    ...
    /**
     * @param \Customweb\FirstDataConnectCw\Model\Authorization\Method\Context\IContext $context
     * @return \Customweb\FirstDataConnectCw\Model\Authorization\Method\Moto
     */
    public function createMoto(\Customweb\FirstDataConnectCw\Model\Authorization\Method\Context\IContext $context)
    {
    	return $this->_objectManager->create('\\Customweb\\FirstDataConnectCw\\Model\\Authorization\\Method\\Moto', ['context' => $context]);
    }

    /**
     * @return \Customweb\FirstDataConnectCw\Model\Authorization\Method\Context\Factory
     */
    ...
    private function getClass(\Customweb_Payment_Authorization_IAdapter $adapter)
    {
       	switch ($adapter->getAuthorizationMethodName()) {
    		case \Customweb_Payment_Authorization_PaymentPage_IAdapter::AUTHORIZATION_METHOD_NAME:
    			return '\\Customweb\\FirstDataConnectCw\\Model\\Authorization\\Method\\PaymentPage';
    		case \Customweb_Payment_Authorization_Hidden_IAdapter::AUTHORIZATION_METHOD_NAME:
    			return '\\Customweb\\FirstDataConnectCw\\Model\\Authorization\\Method\\Hidden';
    		case \Customweb_Payment_Authorization_Ajax_IAdapter::AUTHORIZATION_METHOD_NAME:
    			return '\\Customweb\\FirstDataConnectCw\\Model\\Authorization\\Method\\Ajax';
  			case \Customweb_Payment_Authorization_Iframe_IAdapter::AUTHORIZATION_METHOD_NAME:
  				return '\\Customweb\\FirstDataConnectCw\\Model\\Authorization\\Method\\Iframe';
   			case \Customweb_Payment_Authorization_Server_IAdapter::AUTHORIZATION_METHOD_NAME:
    			return '\\Customweb\\FirstDataConnectCw\\Model\\Authorization\\Method\\Server';
    		case \Customweb_Payment_Authorization_Widget_IAdapter::AUTHORIZATION_METHOD_NAME:
    			return '\\Customweb\\FirstDataConnectCw\\Model\\Authorization\\Method\\Widget';
    		default:
