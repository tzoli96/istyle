...
class TransactionHandler implements \Customweb_Payment_ITransactionHandler
{
	 ...
	 * @param mixed $value
	 * @param string $field
	 * @return null|\Customweb\FirstDataConnectCw\Model\Authorization\Transaction
	 */
	 ...
	 */
	private function storeInCache(\Customweb\FirstDataConnectCw\Model\Authorization\Transaction $transaction)
	{
