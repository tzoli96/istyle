...
class TransactionRepository implements \Customweb\FirstDataConnectCw\Api\TransactionRepositoryInterface
{
	/**
    ...
    /**
     * @var \Customweb\FirstDataConnectCw\Api\Data\TransactionInterfaceFactory
     */
	 ...
	 * @param \Customweb\FirstDataConnectCw\Api\Data\TransactionInterfaceFactory $transactionDataFactory
	...
	public function __construct(
			...
			\Customweb\FirstDataConnectCw\Api\Data\TransactionInterfaceFactory $transactionDataFactory,
	...
	public function getList(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria)
	{
		...
		/** @var \Customweb\FirstDataConnectCw\Model\ResourceModel\Authorization\Transaction\Collection $collection */
	 ...
	 *
	 * @return \Customweb\FirstDataConnectCw\Api\Data\TransactionInterface
	 */
	protected function getDataModel(\Customweb\FirstDataConnectCw\Model\Authorization\Transaction $transaction)
	{
		$transactionDataObject = $this->_transactionDataFactory->create();
		$this->_dataObjectHelper->populateWithArray(
				$transactionDataObject,
				$this->extractTransactionData($transaction),
				'\Customweb\FirstDataConnectCw\Api\Data\TransactionInterface'
		);
		return $transactionDataObject;
	}

	private function extractTransactionData(\Customweb\FirstDataConnectCw\Model\Authorization\Transaction $transaction)
	{
		...
		$data[\Customweb\FirstDataConnectCw\Api\Data\TransactionInterface::TRANSACTION_DATA] = $transactionData;
		return $data;
	}
