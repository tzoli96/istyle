...
class AuthorizationData implements \Customweb\FirstDataConnectCw\Api\Data\AuthorizationDataInterface {
	...
	public function setHiddenFormFields(array $hiddenFormFields)
	{
		...
		foreach ($hiddenFormFields as $key => $value) {
			$field = new \Customweb\FirstDataConnectCw\Model\Service\AuthorizationFormField();
