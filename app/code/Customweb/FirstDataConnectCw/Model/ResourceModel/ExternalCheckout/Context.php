...
namespace Customweb\FirstDataConnectCw\Model\ResourceModel\ExternalCheckout;

class Context extends \Customweb\FirstDataConnectCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_firstdataconnectcw_external_checkout_context_resource';
    ...
    {
        $this->_init('customweb_firstdataconnectcw_external_checkout_context', 'context_id');
    }
