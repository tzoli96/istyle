...
namespace Customweb\FirstDataConnectCw\Model\ResourceModel;
...
class Storage extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_firstdataconnectcw_storage_resource';
    ...
    {
        $this->_init('customweb_firstdataconnectcw_storage', 'key_id');
    }
