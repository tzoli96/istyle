...
namespace Customweb\FirstDataConnectCw\Model\ResourceModel\Authorization;

class Transaction extends \Customweb\FirstDataConnectCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_firstdataconnectcw_transaction_resource';
	...
	public function unserializeTransactionObject(\Customweb\FirstDataConnectCw\Model\Authorization\Transaction $transaction){
    ...
    {
        $this->_init('customweb_firstdataconnectcw_transaction', 'entity_id');
    }
