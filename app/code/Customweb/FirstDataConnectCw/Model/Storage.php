 ...
 * @method \Customweb\FirstDataConnectCw\Model\Storage setKeySpace(string $value)
 * @method string getKeyName()
 * @method \Customweb\FirstDataConnectCw\Model\Storage setKeyName(string $value)
 * @method string getKeyValue()
 * @method \Customweb\FirstDataConnectCw\Model\Storage setKeyValue(string $value)
 */
class Storage extends \Magento\Framework\Model\AbstractModel
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_firstdataconnectcw_storage';
    ...
    {
        $this->_init('Customweb\FirstDataConnectCw\Model\ResourceModel\Storage');
    }
