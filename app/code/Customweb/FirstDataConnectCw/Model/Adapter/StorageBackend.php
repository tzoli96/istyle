...
class StorageBackend implements \Customweb_Storage_IBackend
{
	 ...
	 *
	 * @var \Customweb\FirstDataConnectCw\Model\StorageFactory
	 */
	protected $_storageFactory;

	public function __construct(
			\Customweb\FirstDataConnectCw\Model\StorageFactory $storageFactory
	) {
	...
	/**
	 * @return \Customweb\FirstDataConnectCw\Model\Storage
	 */
