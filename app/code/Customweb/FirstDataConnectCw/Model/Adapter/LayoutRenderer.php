...
class LayoutRenderer extends \Customweb_Mvc_Layout_Renderer
{
	...
	{
		$this->_view->loadLayout(['default', 'firstdataconnectcw_layout_renderer'], true, true, false);
		...
		$this->_view->getPage()->getConfig()->addPageAsset('Customweb_FirstDataConnectCw::css/firstdataconnectcw.css');
	}
	...
	{
		$this->_view->getLayout()->addBlock('\Magento\Framework\View\Element\Text', 'firstdataconnectcw.main.content', 'content')->setText($content);
	}
