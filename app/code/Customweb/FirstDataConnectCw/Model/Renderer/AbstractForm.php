...
class AbstractForm extends \Customweb_Form_Renderer
{
	...
	protected function renderRegisterCallback($jsFunctionPostfix){
		...
		$registerJs = "require(['jquery', 'domReady', 'Customweb_FirstDataConnectCw/js/form'], function($, domReady, Form){\n";
	...
	{
		$eventJs = "require(['jquery', 'domReady', 'Customweb_FirstDataConnectCw/js/form', 'mage/template'], function($, domReady, Form, mageTemplate){\n";
