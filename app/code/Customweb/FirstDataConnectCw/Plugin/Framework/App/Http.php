...
namespace Customweb\FirstDataConnectCw\Plugin\Framework\App;

class Http
{

	/**
	 * @var \Customweb\FirstDataConnectCw\Model\Logging\Listener
	 */
	private $_loggingListener;

	/**
	 * @param \Customweb\FirstDataConnectCw\Model\Logging\Listener $loggingListener
	 */
	public function __construct(
			\Customweb\FirstDataConnectCw\Model\Logging\Listener $loggingListener
	) {
	...
	{
		\Customweb_I18n_Translation::getInstance()->addResolver(new \Customweb\FirstDataConnectCw\Model\TranslationResolver());
	}
