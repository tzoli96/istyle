	...
	var AuthorizationMethod = function(formElement, authorizationUrl) {
		...
		this.redirect = function(orderId) {
			...
			if (!customer.isLoggedIn()) {
				serviceUrl = urlBuilder.createUrl('/guest-carts/:cartId/firstdataconnectcw/checkout/authorize', {
					cartId: quote.getQuoteId()
				});
			} else {
				serviceUrl = urlBuilder.createUrl('/carts/mine/firstdataconnectcw/checkout/authorize', {});
			}
			return storage.post(
