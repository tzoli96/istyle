requirejs(['algoliaBundle'], function(algoliaBundle) {
    algoliaBundle.$(function ($) {
        ...
        $(div).addClass('algolia-instant-results-wrapper row mb-3');

        $(algoliaConfig.instant.selector).addClass('algolia-instant-replaced-content');
        $(algoliaConfig.instant.selector).wrap(div);

        $('.algolia-instant-results-wrapper').append('<div class="row mb-3 algolia-instant-selector-results"></div>');
        ...
        var allWidgetConfiguration = {
            ...
            currentRefinedValues: {
                ...
                templates: {
                    header: '<strong class="block-subtitle filter-current-subtitle" role="tab" aria-level="2" data-role="title" aria-selected="false" aria-expanded="false" tabindex="0">' + algoliaConfig.translations.selectedFilters + '</strong>',
