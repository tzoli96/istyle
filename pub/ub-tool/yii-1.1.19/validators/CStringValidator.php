...
class CStringValidator extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		{
			$message=$this->tooLong!==null?$this->tooLong:Yii::t('yii','{attribute} is ({value}) too long (maximum is {max} characters).');
			$this->addError($object,$attribute,$message,array('{max}'=>$this->max, '{value}'=>$value));
		}
