...
class Mage2SalesQuote extends Mage2ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('items_qty, store_to_base_rate, store_to_quote_rate, grand_total, base_grand_total, base_to_global_rate, base_to_quote_rate, subtotal, base_subtotal, subtotal_with_discount, base_subtotal_with_discount', 'length', 'max'=>13),
