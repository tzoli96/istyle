 ...
 */
class Mage2NewsletterTemplate extends Mage2ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('template_text, template_styles, added_at, modified_at', 'safe')
		);
	}
	 ...
	 * @return Mage2NewsletterTemplate the static model class
	 */
