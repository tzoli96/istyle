...
class Mage2SalesOrderPayment extends Mage2ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('base_shipping_captured, shipping_captured, amount_refunded, base_amount_paid, amount_canceled, base_amount_authorized, base_amount_paid_online, base_amount_refunded_online, base_shipping_amount, shipping_amount, amount_paid, amount_authorized, base_amount_ordered, base_shipping_refunded, shipping_refunded, base_amount_refunded, amount_ordered, base_amount_canceled, cc_exp_month, cc_ss_start_year', 'length', 'max'=>13),
