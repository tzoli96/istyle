...
class Mage2SalesQuoteAddress extends Mage2ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('firstname, lastname, email, company, street, shipping_description, discount_description', 'length', 'max'=>255),
			array('middlename, prefix, suffix, city, region, shipping_method', 'length', 'max'=>40),
			array('postcode, telephone, fax', 'length', 'max'=>20),
			array('country_id', 'length', 'max'=>30),
			array('weight, subtotal, base_subtotal, subtotal_with_discount, base_subtotal_with_discount, tax_amount, base_tax_amount, shipping_amount, base_shipping_amount, shipping_tax_amount, base_shipping_tax_amount, discount_amount, base_discount_amount, grand_total, base_grand_total, shipping_discount_amount, base_shipping_discount_amount, subtotal_incl_tax, base_subtotal_total_incl_tax, discount_tax_compensation_amount, base_discount_tax_compensation_amount, shipping_discount_tax_compensation_amount, base_shipping_discount_tax_compensation_amnt, shipping_incl_tax, base_shipping_incl_tax', 'length', 'max'=>13),
