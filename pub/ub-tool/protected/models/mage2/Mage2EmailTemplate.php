 ...
 */
class Mage2EmailTemplate extends Mage2ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('template_code, template_text, template_subject, added_at, modified_at', 'required'),
			...
			array('template_styles, orig_template_variables', 'safe')
		);
	}
	 ...
	 * @return Mage2EmailTemplate the static model class
	 */
