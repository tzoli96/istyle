 ...
 */
class Mage2CatalogProductEntityMediaGalleryValueToEntity extends Mage2ActiveRecord
{
	/**
	 ...
	 * @return Mage2CatalogProductEntityMediaGalleryValueToEntity the static model class
	 */
