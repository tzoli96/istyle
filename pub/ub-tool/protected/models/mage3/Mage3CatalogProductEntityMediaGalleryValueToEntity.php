 ...
 */
class Mage3CatalogProductEntityMediaGalleryValueToEntity extends Mage3ActiveRecord
{
	/**
	 ...
	 * @return Mage3CatalogProductEntityMediaGalleryValueToEntity the static model class
	 */
