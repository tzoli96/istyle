 ...
 */
class Step4Controllerorig extends BaseController
{
        ...
        if ($check['allowed']) {
            ...
            try {
                ...
                if ($selectedCategoryIds) {
                    ...
                    {
                        if(Mage3CatalogCategoryEntity::model()->count("entity_id = {$m2_id}")>0) {}
                        else
                        {
                    ...
                    $categories = UBMigrate::getListObjects('Mage3CatalogCategoryEntity', $condition, -1, -1, "level ASC, entity_id ASC");
                    /** @var Mage3CatalogCategoryEntity $category */
    ...
    private function _migrateCatalogCategories($categories, $mappingStores)
    {
        ...
        foreach ($categories as $category) {
            ...
            if(!is_null($m2Id))
            {
                $category2 = Mage3CatalogCategoryEntity::model()->find("entity_id = {$m2Id}");
            ...
            if (is_null($m2Id)) {
                $category2 = new Mage3CatalogCategoryEntity();
    ...
    /**
     * @param $category Mage3CatalogCategoryEntity
     * @param $mappingStores
     * @return bool
     */
