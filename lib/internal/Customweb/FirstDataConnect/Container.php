 ...
 *
 */
class Customweb_FirstDataConnect_Container extends Customweb_Payment_AbstractContainer {
	...
	public function getConfiguration(){
		return $this->getBean('Customweb_FirstDataConnect_Configuration');
	}
	...
	public function getMethodFactory(){
		return $this->getBean('Customweb_FirstDataConnect_Method_Factory');
	}
	 ...
	 * @return Customweb_FirstDataConnect_Method_DefaultMethod
	 */
	 ...
	 * @return Customweb_FirstDataConnect_Method_DefaultMethod
	 */
	public function getPaymentMethodByTransaction(Customweb_FirstDataConnect_Authorization_Transaction $transaction){
