 ...
 */
class Customweb_FirstDataConnect_Method_DirektUeberweisungMethod extends Customweb_FirstDataConnect_Method_DefaultMethod {
	...
	public function getAuthorizationParameters(Customweb_FirstDataConnect_Authorization_Transaction $transaction, array $formData, $authorizationMethod) {
		...
		switch ($verification) {
			case Customweb_FirstDataConnect_IConstants::DU_VERIFICATION_AGE:
				$parameters['ident_actiontype'] = '4';
				break;
			case Customweb_FirstDataConnect_IConstants::DU_VERIFICATION_IDENTIFICATION:
				$parameters['ident_actiontype'] = '5';
				break;
			case Customweb_FirstDataConnect_IConstants::DU_VERIFICATION_AUTHENTICATION:
				$parameters['ident_actiontype'] = '6';
				break;
			case Customweb_FirstDataConnect_IConstants::DU_VERIFICATION_BANKACCOUNT:
				$parameters['ident_actiontype'] = '7';
				break;
			case Customweb_FirstDataConnect_IConstants::DU_VERIFICATION_NONE:
			default:
				break;
		}
		return $parameters;
